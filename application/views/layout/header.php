...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    if( $user['role'] == 'Admin'){ ?>
      <li class="nav-item">
      <a class="nav-link collapsed" a href="<?=site_url("/Mahasiswa")?>">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" a href="<?= site_url("/Prodi")?>">
        <i class="fas fa-fw fa-users"></i>
        <span>Prodi</span>
      </a>
    </li>
      ...
      <li class="nav-item">
      <a class="nav-link collapsed" a href="<?= site_url("/Capres")?>">
        <i class="fas fa-fw fa-users"></i>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" a href="<?= site_url("/Barang")?>">
        <i class="fas fa-fw fa-users"></i>
        <span>Barang</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" a href="<?= site_url('/Profil')?>">
        <i class="fas fa-fw fa-users"></i>
        <span>Profil</span>
      </a>  
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" a href="<?= site_url("Auth/logout")?>">
        <i class="fas fa-fw fa-users"></i>
        <span>Logout</span>
      </a>
    </li>  
