                ...
                <div class="card-body">
                  ...
                  <form class="user" method="POST" action="<?= base_url('auth/registrasi'); ?>">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="password" name="password1" class="form-control" id="password1" value="<?= set_value('password1'); ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Masukkan ulang password anda</div>
                      <?= form_error('nama', '<small class="text-danger pl-3">','</small>'); ?>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="<?= base_url('index.php/auth')?>">Log in</a></p>
                    </div>
                  </form>
                </div>
              </div>
